...
ap.add_argument("-m", "--model", type=str, default="gender_detection",  # Không bao gồm phần mở rộng
...
model_json_path = os.path.join(base_path, args.model + ".json")
model_weights_path = os.path.join(base_path, args.model + ".h5")
...
# Lưu mô hình dưới dạng JSON và trọng số dưới dạng HDF5
